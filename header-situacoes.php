...
<body <?php body_class(); ?>>
	<div id="wrapper">
		...
		<div id="header-situacoes">
			<a href="<?php echo home_url( '/projetos/situacoes/' ); ?>" class="link-header-situacoes" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
            </a>
		</div><!-- /#header -->
